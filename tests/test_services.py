...
def test_add_transaction_and_assets_creation():
    ...
    AssetService.add_transaction("MOCK4", "2021-04-30", "Compra", 100, 20.00, 5.0)
...
def test_average_price_calculation():
    ...
    AssetService.add_transaction("BBAS3", "2021-04-30", "Compra", 100, 20.00)
    ...
    AssetService.add_transaction("BBAS3", "2021-05-15", "Compra", 100, 30.00)
    df = DashboardService.calculate_positions()
    assert df.loc[0, "quantity"] == 200
    assert df.loc[0, "average_price"] == 25.00 
    
    AssetService.add_transaction("BBAS3", "2021-06-01", "Venda", 50, 40.00)
    df = DashboardService.calculate_positions()
    assert df.loc[0, "quantity"] == 150
    assert df.loc[0, "average_price"] == 25.00 
    
    AssetService.add_transaction("BBAS3", "2021-07-01", "Compra", 50, 15.00)
    df = DashboardService.calculate_positions()
    assert df.loc[0, "quantity"] == 200
...
def test_dividends_time_windows():
    ...
    AssetService.add_transaction("BBAS3", "2021-04-30", "Compra", 100, 20.00)
    AssetService.add_dividend("BBAS3", "2026-06-11", "Dividendo", 100.00)
    AssetService.add_dividend("BBAS3", "2025-11-15", "Dividendo", 50.00)
    AssetService.add_dividend("BBAS3", "2024-11-15", "Dividendo", 30.00)
...
def test_historical_evolution_calculation():
    ...
    AssetService.add_transaction("BBAS3", "2025-01-10", "Compra", 10, 20.00) 
    AssetService.add_transaction("BBAS3", "2025-02-15", "Compra", 10, 30.00) 
    AssetService.add_dividend("BBAS3", "2025-02-28", "Dividendo", 50.00)       
...
def test_b3_resgate_logic():
    ...
    AssetService.add_transaction("NUBR33", "2021-12-10", "Compra", 239, 8.36)
...
def test_get_quantity_on_date():
    ...
    AssetService.add_transaction("BBAS3", "2025-01-01", "Compra", 100, 20.00)
    AssetService.add_transaction("BBAS3", "2025-03-01", "Compra", 100, 22.00)
    AssetService.add_transaction("BBAS3", "2025-05-01", "Venda", 50, 25.00)
...
def test_asset_annual_dividends_pivot():
    ...
    AssetService.add_dividend("BBAS3", "2025-05-15", "Dividendo", 50.00)
    AssetService.add_dividend("BBAS3", "2025-08-15", "JCP", 30.00)
    AssetService.add_dividend("CXSE3", "2025-05-15", "Dividendo", 100.00)
    AssetService.add_dividend("BBAS3", "2024-05-15", "Dividendo", 15.00)
...
def test_get_current_simulation_math():
    ...
    AssetService.add_transaction("BBAS3", "2021-12-15", "Compra", 10, 10.00)
